<tbody>
    @forelse ($player_lists as $lists)
        <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            <td class="px-4 py-3">
                <span class="bg-primary-100 text-primary-800 text-md font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300">{{ $lists->sports->sports_category}}</span>
            </td>
            <td class="px-4 py-3">
