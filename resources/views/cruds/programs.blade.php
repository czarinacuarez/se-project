                        ...
                        <div class="w-full md:w-1/2">
                            <form class="flex items-center">
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input type="text" id="simple-search" placeholder="Search for programs" required="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                </div>
                            </form>
                        </div>
        ...
        <form method="POST" action="{{ url('update_program', ['id' => $lists->id]) }}" enctype="multipart/form-data" id="drawer-update-product-{{ $lists->id}}" class="fixed top-0 left-0 z-40 w-full h-screen max-w-xl p-4 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-update-product-label" aria-hidden="true">
            ...
            <div class="mb-4">
                <div class="grid grid-cols-2 gap-4 sm:col-span-2">
                    <div>
                        <label for="program_initials" class="block text-sm font-medium text-gray-900 dark:text-white">Program Initial</label>
                        <input type="text" name="program_initials" id="program_initials" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{ $lists->program_initials }}" placeholder="Type product name" required="">
                    </div>  
                    <div>
                        <label for="program_name" class="block text-sm font-medium text-gray-900 dark:text-white">Program Name</label>
                        <input type="text" name="program_name" id="program_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{ $lists->program_name }}" placeholder="Type product name" required="">
                    </div>     
                </div>
            </div>
            <div>
            ...
            <div class="relative w-full h-auto max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <form method="POST" action="{{ url('delete_program', ['id' => $lists->id]) }}">
                            @csrf
                            @method('DELETE')
