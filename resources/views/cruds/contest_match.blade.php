        ...
        <form method="POST" action="{{ url('update_contest_match', ['id' => $lists->id]) }}" enctype="multipart/form-data" id="drawer-update-match-{{ $lists->id}}" class="fixed top-0 left-0 z-40 w-full h-screen max-w-xl p-4 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-update-match-label" aria-hidden="true">
            ...
            <div class="mb-4">
                <div>
                    ...
                    <input type="date" name="date" id="date" value="{{ $lists->date }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type match name" required="">
                </div>
            </div>
            <div class="mb-4">
                <div>
