...
<x-admin-layout>
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            @include('crud_components.participants_table')
                        </table>
                    </div>
                </div>
            </div>
    ...
    <!-- End block -->
    <div id="participantsModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] md:h-full">
        <div class="relative p-4 w-full max-w-3xl h-full md:h-auto">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                    ...
                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="participantsModal">
                ...
                <!-- Modal body -->
                <form method="POST" action="{{ url('add_participants') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="grid gap-4 mb-4 ">
                        <div>
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Members Name</label>
                        ...
                        <div>
                            <div class="flex gap-2">
                                <label for="contest_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Contest</label>
                                <button type="button" id="createSportsModal" data-modal-target="contestModal" data-modal-toggle="contestModal" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                    ...
                    <div class="items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                        <button type="submit" class="bg-blue-500 w-full sm:w-auto justify-center text-white inline-flex bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Add Participants</button>
                        <button data-modal-toggle="participantsModal" type="button" class="w-full justify-center sm:w-auto text-gray-500 inline-flex items-center bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-primary-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
        ...
        <form method="POST" action="{{ url('update_participants', ['id' => $lists->id ]) }}" enctype="multipart/form-data" id="drawer-update-product-{{ $lists->id }}" class="fixed top-0 left-0 z-40 w-full h-screen max-w-xl p-4 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-update-product-label" aria-hidden="true">
            ...
            <div class="mb-4">
                <div class="grid grid-cols-2 gap-4 sm:col-span-2">
                    <div>
                        <label for="name" class="block text-sm font-medium text-gray-900 dark:text-white">Participants Name</label>
                    ...
                    <div>
                        <label for="section" class="block text-sm font-medium text-gray-900 dark:text-white">Participants Section</label>
            ...
            <div class="relative w-full h-auto max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <form method="POST" action="{{ url('delete_participants', ['id' => $lists->id]) }}">
                            @csrf
                            @method('DELETE')
