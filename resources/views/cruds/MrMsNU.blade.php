                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr>
                                    ...
                                    <th scope="col" class="p-4">Awards</th>
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <form method="POST" action="{{ url('add_contestants') }}" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            <label for="awards" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Awards</label>
                            <input type="text" name="awards" id="awards" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type product name" required="">
                        </div>
                        <div class="mb-4">
    ...
    @forelse($contestant_lists as $lists)
        <form method="POST" action="{{ url('update_contestant', ['id' => $lists->id]) }}" enctype="multipart/form-data" id="drawer-update-product-{{ $lists->id}}" class="fixed top-0 left-0 z-40 w-full h-screen max-w-xl p-4 overflow-y-auto transition-transform -translate-x-full bg-white dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-update-product-label" aria-hidden="true">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    <label for="awards" class="block text-sm font-medium text-gray-900 dark:text-white mb-2">Awards</label>
                    <input type="text" name="awards" id="awards" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" value="{{ $lists->awards }}" placeholder="Type product name" required="">
                </div> 
                <div class="mb-4">
                    <div class="flex gap-2">
                        <label for="program_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Program</label>
