<x-guest-layout>
    ...
    <div class = "p-5 max-w-7xl mx-auto">
        ...
        <p class = " text-base lg:text-lg lg:text-center text-center text-white lg:pe-10  py-2">University Week stands out as
    ...
    <div class = " p-5 md:p-10 ">
        ...
        <div id="" class="max-w-4xl shadow-lg p-5 my-5 mx-auto bg-white rounded-lg">
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-3 py-4">
                                <div class="flex flex-col items-start">
                                    <div class="mb-5">
                                        <h1 class="text-xl font-bold">2nd Place</h1>
                                    </div>
                                    <div class="mt-5 mb-5">
                                        <h1 class="text-xl font-bold">2nd Place</h1>
                                    </div>
