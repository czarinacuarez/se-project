            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <form method="POST" action="{{ url('add_contestants') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="mb-4">
                            <div class="flex gap-2">
                                <label for="program_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name</label>
                        ...
                        <div class="mb-4">
                            <div class="flex gap-2">
                                <label for="program_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Placements</label>
                                
                            </div>
                            <select id="program_id" name="program_id" class="p-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                <option class="p-2" value="">Mr NU</option>
                                <option class="p-2" value="">Ms NU</option>
                                <option class="p-2" value="">1st Runner Up</option>
                                <option class="p-2" value="">2nd Runner Up</option>
                                <option class="p-2" value="">Top 6</option>
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <form method="POST" action="{{ url('add_contestants') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="mb-4">
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Special Awards</label>
